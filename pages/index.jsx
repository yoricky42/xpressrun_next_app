    ...
    <div className={style.home}>
      ...
      >
        <div className={`${style.affordablePart } ${style.paddingHomeCenter}`}>
          <div
            className={`${affordable ? `${style.affordablePartText}` : `${style.affordablePartTextOFF}`}`}
          >
            <p
              style={{ margin: "15px 0" }}
            ...
            >
              <a className={`${style.smallTypeTextAffordableLinkPart}`}>
                <span className={`${style.smallTypeTextAffordable} ${style.smallTypeTextAffordableLink}`}>
                  Learn more
                </span>
          ...
          <div
            className={`${
              affordable ? `${style.affordableCardPart}` : `${style.affordableCardPartOFF}`
            }`}
          >
      ...
      >
        <div className={`${style.affordablePart} ${style.paddingHomeCenter} ${style.reverse}`}>
          <div
            className={`${
              Seamless ? `${style.affordableCardPart}` : `${style.affordableCardPartOFF}`
            }`}
          >
            <div  className={`${style.affordableCard}`}>
          ...
          <div
            className={`${Seamless ? `${style.affordablePartText}` : `${style.affordablePartTextOFF}`}`}
          >
            <p
              style={{ margin: "15px 0" }}
              className={`${style.smallTypeTextAffordable}`}
      ...
      >
        <div className={`${style.affordablePart} ${style.paddingHomeCenter}`}>
          <div
            className={`${
              delivery ? `${style.affordablePartText}` : `${style.affordablePartTextOFF}`
            }`}
          >
            <p
              style={{ margin: "15px 0" }}
            ...
            <div
              style={{ margin: "15px 0" }}
              className="bigTypeTextAffordable"
            >
          ...
          <div
            className={`${delivery ? `${style.affordableCardPart}` : `${style.affordableCardPartOFF}` }`}
          >
            <div className={`${style.affordableCard}`}>
      ...
      >
        <div className={`${style.fullyPart} ${style.paddingHomeCenter}`}>
          <div
            className={`${Fully ? `${style.fullyPartTextContent}` : `${style.fullyPartTextContentOFF}` }`}
          >
            <div className={`${Fully ? `${style.blancFake}` : `${style.blancFakeOFF}`}`}></div>
            <div className={`${style.fullyPartBIG}`}>
              <p className={`${style.bigTypeTextAffordable} ${style.bigTypeTextAffordableFully}`}>
                Fully Automated
              </p>
              <p className={`${style.bigTypeTextAffordable} ${style.bigTypeTextAffordableFully}`}>
                Last-mile
            ...
            <p className={`${style.smallTypeTextAffordable} ${style.smallTypeTextAffordableLong} ${style.smallTypeTextFullyLong}`}>
          ...
          >
            <a className={`${card ? `${style.Oncard}` : `${style.Oncard3}`}`}>
              <div className={`${style.api} ${style.api3}`}>
                <Image src={api3} alt="" className={`${style.iconCardImageApi}`} />
              </div>
        ...
        <div className={`${style.currentlyPart}`}>
          ...
          <div className={`${style.currentlyElementContainer}`}>
            ...
            <div className={`${style.currentlyElementCard2}`}>
              ...
              <a href="https://apps.shopify.com/xpressrun" target="_blank" rel="noreferrer">
                <div className={`${style.currentlyElementCard2_1 } ${style.shoopifyCardBlack}`}>
                  <Image
                    src={shoopifyCardBlack}
                    alt=""
                  />
                </div>
              </a>
